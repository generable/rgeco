---
title: "Getting-started-survival-data"
...
```{r, eval = NOT_CRAN}
subjects <- get_geco_subjects(project = demo_project, event_type = 'overall_survival')
```
